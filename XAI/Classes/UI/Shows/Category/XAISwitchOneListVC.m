...
#define _ST_SwitchOneListVCID @"XAISwitchOneListVCID"

@interface XAISwitchOneListVC ()

@end

@implementation XAISwitchOneListVC

+(UIViewController*)create{
    
    UIStoryboard* show_Storyboard = [UIStoryboard storyboardWithName:@"Show_iPhone_Sec" bundle:nil];
    UIViewController* vc = [show_Storyboard instantiateViewControllerWithIdentifier:_ST_SwitchOneListVCID];
